...
* **+** очень большое количество компонентов и [виджетов](#widget)
* **+** богатый и продуманный функционал _части_ компонентов
...
### 
* **-** некоторые элементы компонентов могут быть сложно кастомизируемыми (стилизация)
...
* **+** в первую очередь содержит много фундаментальных элементов из которых уже сделаны или просто можно сделать самому любые более сложные компоненты
