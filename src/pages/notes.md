...
Фундаментальным плюсом у cookie является невозможность доступа из JS при использовании флага HttpOnly, при необходимости соблюдения повышанного уровня безопасности необходимо использовать этот подход. Если же необходимо управлять "токеном" из JS, то лучше будет использовать localStorage.
