...
#### Декларативное и императивное программирование (разница)
...
Императивное программирование предполагает описывать инструкции и их последовательные связи с использованием низкоуровневых (в рамках ЯП) выражений.

При этом, если подумать, любой оператор выражения — в действтиельности задекларированная ЯП инструкция. Это одно из доказательств того что программа — это конечный автомат.
